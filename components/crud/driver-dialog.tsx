  ...
  async function submit() {
    ...
    try {
      const duplicatePhoneNumber = drivers.find(
        (item) =>
          form.mobile_number === item.mobile_number && item.id !== editing?.id,
      );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>
            {editing ? t("driver.edit") : t("driver.add")}
          </DialogTitle>
          <DialogDescription>{t("driver.dialogdesc")}</DialogDescription>
        </DialogHeader>
                ...
                {/* <SwitchField
                  ...
                  onChange={(v) =>
                    set("certifications", {
                      ...form.certifications,
                      wheelchairAssist: {
                        ...form.certifications.wheelchairAssist,
                        enabled: v,
                      },
                    })
                  }
                ...
                <SwitchField
                  ...
                  onChange={(v) =>
                    set("certifications", {
                      ...form.certifications,
                      medicalTransport: {
                        ...form.certifications.medicalTransport,
                        enabled: v,
                      },
                    })
                  }
