...
export const THEMES: { id: Theme; label: string; hint: string; swatch: string[] }[] = [
  { id: 'light', label: 'themes.clinicalLight.label', hint: 'themes.clinicalLight.hint', swatch: ['#f5f7fa', '#2f6fed', '#38bdf8'] },
  { id: 'dark', label: 'themes.clinicalDark.label', hint: 'themes.clinicalDark.hint', swatch: ['#1b2130', '#4d8bf5', '#37c4d6'] },
  { id: 'onlok', label: 'themes.onlok.label', hint: 'themes.onlok.hint', swatch: ['#f2fcfa', '#135b55', '#f59e42'] },
  { id: 'evergreen', label: 'themes.evergreen.label', hint: 'themes.evergreen.hint', swatch: ['#f6f8f1', '#2f6b46', '#e0a341'] },
  { id: 'sunrise', label: 'themes.sunrise.label', hint: 'themes.sunrise.hint', swatch: ['#fdf7f1', '#d5713f', '#128b86'] },
]
